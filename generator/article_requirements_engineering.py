...
lead = """At the beginning of each project, you should know your desired outcomes. That is a universal rule regardless of your project type - whether it is a software application or a new steering wheel for a car. This piece presents some aspects of software requirements engineering (but many things are universally correct). Especially available standards you should know about and suggested ways and technologies that might help you when defining requirements."""

content = """<p class="lead">At the beginning of each project, you should know your desired outcomes. That is a universal rule regardless of your project type - whether it is a software application or a new steering wheel for a car. This piece presents some aspects of software requirements engineering (but many things are universally correct). Especially available standards you should know about and suggested ways and technologies that might help you when defining requirements.</p>
<!-- LATEX-ALL-EM-AS-TEXT -->
<p>Requirements engineering is about defining what you want to do and partially why. It does not answer the question of how (which is the subject of design engineering). Defining requirements is (or should be) the first step in each project. The advantage of clearly defined requirements before you take the next step (designing) is clear - it can help you save a lot of time, money and many angry customers. Without it, you may quickly end up in the situation when you rebuild your application (or whatever you do) every few weeks and lose a lot of resources on the road. It also irritates engineers who work on your project as almost nobody wants to do the same work repeatedly just because of messy management. It is also incredibly beneficial to know the bigger picture in advance to prevent miscommunications and misunderstandings. Ultimately, weak requirements can lead to significant losses - e. g. no customer wants to re-learn how to use anything every couple of weeks. Plus, if you follow the standard way, the whole process can help you to clear your mind - you are ultimately the one who needs to know what to do and why.</p>

<h2>What to cover, outputs, and who is in charge?</h2>
<p>Standard software lifecycle comprises requirement specification, design, implementation, and validation. These four steps are valid in almost every project management framework (maybe with some small modifications). They definitely should be followed in Agile/SCRUM and Waterfall based frameworks (representing the current engineering standard).</p>
